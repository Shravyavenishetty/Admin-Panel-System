...
import { getAllOutlets, createOutlet, deleteOutlet } from '../services/outletService';
        ...
        <div className="p-8">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-white/70">Manage your outlet locations</p>
                </div>
                <button
            ...
            {showForm && (
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 mb-6">
                    <h2 className="text-xl font-bold text-white mb-4">Add New Outlet</h2>
